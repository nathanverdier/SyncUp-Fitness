    ...
    try:
        while True:
            ...
            if results.pose_landmarks:
                ...
                # Points clés pour le bench press (côté gauche)
                ...
                # Détection du mouvement du Bench Press
                if elbow_angle > 150 and shoulder_angle > 40:
                    bench_stage = "up"  # Bras tendus en haut
                if elbow_angle < 90 and shoulder_angle < 30 and bench_stage == "up":
                    bench_stage = "down"  # En position basse (barre près de la poitrine)
                    bench_counter += 1
                    print(f"Bench Press: {bench_counter}")
                ...
                # Affichage du compteur et de l'état du bench press
                cv2.rectangle(frame_bgr, (0, 0), (300, 60), (245, 117, 16), -1)
                cv2.putText(frame_bgr, f"BENCH PRESS: {bench_counter} | {bench_stage}",
                            (10, 40),
            ...
            cv2.imshow("Bench Press Tracker", frame_bgr)
